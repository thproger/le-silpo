...
def create_order(order_input: OrderInput, tax, sesion: Session) -> Order:
    order = Order(latitude=order_input.latitude, longitude=order_input.longitude, subtotal=order_input.subtotal, tax=tax['composite_tax_rate'])
